...
exports.SecurityError = exports.NetworkError = exports.CacheError = exports.FetchYourKeysError = exports.FetchYourKeys = void 0;
...
exports.FetchYourKeysError = FetchYourKeysError;
...
class SecureDiskCache {
    ...
    generateCacheId() {
        return (0, crypto_1.scryptSync)(this.apiKey, 'cache-id-salt-v2', 16).toString('hex');
    }
    getCacheFilePath() {
        ...
        return (0, path_1.join)(cacheDir, 'fetchyourkeys', `cache-${this.cacheId}.dat`);
    }
    ...
    generateCacheSignature() {
        return (0, crypto_1.scryptSync)(this.apiKey, 'disk-cache-signature-v2', 16).toString('hex');
    }
    ensureCacheDirectory() {
        const cacheDir = (0, path_1.dirname)(this.cacheFile);
    ...
    loadFromDisk() {
        try {
            if ((0, fs_1.existsSync)(this.cacheFile)) {
                const encryptedData = (0, fs_1.readFileSync)(this.cacheFile, 'utf8');
    ...
    saveToDisk() {
        try {
            ...
            (0, fs_1.writeFileSync)(this.cacheFile, encryptedData, { mode: 0o600 });
        }
        catch (error) {
    ...
    clear() {
        ...
        try {
            if ((0, fs_1.existsSync)(this.cacheFile)) {
                (0, fs_1.writeFileSync)(this.cacheFile, '');
            }
        }
        catch (error) {
    ...
    isValidForApiKey(apiKey) {
        try {
            const expectedSignature = (0, crypto_1.scryptSync)(apiKey, 'disk-cache-signature-v2', 16).toString('hex');
...
class SecureMemoryCache {
    ...
    generateCacheId() {
        return (0, crypto_1.scryptSync)(this.apiKey, 'memory-cache-id-v2', 16).toString('hex');
    }
    ...
    static generateCacheKey(apiKey) {
        return (0, crypto_1.scryptSync)(apiKey, 'memory-cache-key-v2', 16).toString('hex');
    }
    generateEncryptionKey() {
        return (0, crypto_1.scryptSync)(this.apiKey, 'fetchyourkeys-memory-cache-v2', 32);
    }
    generateCacheSignature() {
        return (0, crypto_1.scryptSync)(this.apiKey, 'memory-cache-signature-v2', 16).toString('hex');
    }
    set(key, value) {
        this.cache.set(key, value);
    }
    ...
    isValidForApiKey(apiKey) {
        try {
            const expectedSignature = (0, crypto_1.scryptSync)(apiKey, 'memory-cache-signature-v2', 16).toString('hex');
            return this.cacheSignature === expectedSignature;
        }
        catch (error) {
            return false;
...
exports.FetchYourKeys = FetchYourKeys;
